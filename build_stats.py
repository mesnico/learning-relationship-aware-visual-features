...
if __name__ == '__main__':
    ...
    gt_orders = {}
    gt_orders['graph'] = graphs_order.GraphsOrder(args.graph_ground_truth, args.cpus)
    gt_orders['graph-approx'] = graphs_approx_order.GraphsApproxOrder(args.graph_ground_truth, args.cpus)
